    ...
    <section className="grid gap-5 xl:grid-cols-[1.02fr_0.98fr]">
      ...
      <div className="grid gap-5">
        <article className="rounded-3xl border border-[#dfd7cc] bg-white p-6 lg:p-8">
          ...
          <h1 className="mt-4 text-[42px] leading-tight font-semibold tracking-[-0.03em] text-[#111111] lg:text-[48px]">{salon.name}</h1>
          <p className="mt-2 text-[17px] text-[#4f493f]">★ {salon.rating} ({salon.reviewCount.toLocaleString()}) · 리뷰 {salon.reviewCount.toLocaleString()}</p>
        ...
        <aside className="rounded-3xl border border-[#dfd7cc] bg-white p-5">
          <h2 className="text-[28px] font-semibold tracking-[-0.02em] text-[#111111]">고객 평점</h2>
