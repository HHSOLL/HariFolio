...
export function DesignerCard({ designer }: DesignerCardProps) {
  return (
    <article className="rounded-[22px] border border-[#dfd8ce] bg-white p-3 shadow-[0_8px_22px_rgba(20,16,12,0.04)]">
      <div className="relative mb-3.5 rounded-[18px] border border-[#ece5db] bg-[#f5f1eb] p-2">
        <BookmarkDesignerButton designerId={designer.id} className="absolute right-3.5 top-3.5 z-10" />
        <div className="relative h-52 overflow-hidden rounded-[999px_999px_14px_14px] bg-[#ece7df]">
      ...
      <h3 className="text-[28px] leading-tight font-semibold tracking-[-0.03em] text-[#111111]">{designer.name}</h3>
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <Link
          ...
          className="rounded-xl border border-[#d7d1c8] bg-[#f9f6f1] px-3 py-2 text-[13px] font-medium text-[#111111]"
        >
          프로필 보기
        </Link>
      </div>
